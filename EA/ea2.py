...
def main():
    ...
    # User parameters
    # ---------------------------------------------------------
    final_size = 100          # must be even, since 2 values = 1 action
    ...
    print("Final reward:", fitness_function(best_list_so_far, True))
